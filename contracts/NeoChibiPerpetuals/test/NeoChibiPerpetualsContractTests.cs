...
namespace NeoChibiPerpetualsTests
{
    ...
    public class NeoChibiPerpetualsContractTests : IClassFixture<CheckpointFixture<NeoChibiPerpetualsContractTests>>
    {
        ...
        public NeoChibiPerpetualsContractTests(CheckpointFixture<NeoChibiPerpetualsContractTests> fixture)
        {
